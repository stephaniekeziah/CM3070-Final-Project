...
Grad-CAM - Highlights the important regions in the mammogram that influenced the model’s prediction.

LIME - Identifies the most important image regions using superpixel segmentation and local explanations.
